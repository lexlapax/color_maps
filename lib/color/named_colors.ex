defmodule Color.NamedColors do
  #taken from https://github.com/matplotlib/matplotlib/blob/main/lib/matplotlib/_color_data.py
  base_colors = %{
    "r" => "#ff0000", #{1, 0, 0},        # red
    "g" => "#007f00", #{0, 0.5, 0},      # green
    "b" => "#0000ff", #{0, 0, 1},        # blue
    "c" => "#00ffff", #{0, 0.75, 0.75},  # cyan
    "m" => "#ff00ff", #{0.75, 0, 0.75},  # magenta
    "y" => "#ffff00", #{0.75, 0.75, 0},  # yellow
    "k" => "#000000", #{0, 0, 0},        # black
    "w" => "#ffffff", #{1, 1, 1},        # white
  }
...
# https://drafts.csswg.org/css-color-4/#named-colors
  ...
  @named_colors Map.merge(css4_colors, base_colors) |> Map.merge(xkcd_colors) |> Map.merge(tableau_colors)
  # @spec named_colors :: %{String.t() => <<_::56>>}
  @spec named_colors :: %{optional(nonempty_binary) => <<_::56>>}
  def named_colors do
    @named_colors
  end
end
