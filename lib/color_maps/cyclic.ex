defmodule ColorMaps.Cyclic do
  @moduledoc """
  See https://github.com/matplotlib/matplotlib/blob/main/lib/matplotlib/_cm_listed.py
  """

  @behaviour ColormapBehaviour
  @url "https://github.com/matplotlib/matplotlib/blob/main/lib/matplotlib/_cm_listed.py"
  ...
  twilight_length=length(m_twilight_data)
  m_twilight_shifted = Enum.reverse(Enum.take(m_twilight_data, div(twilight_length,2)))
    ++ Enum.reverse(Enum.take(m_twilight_data, -div(twilight_length,2)))

  @palettes %{
    :twilight => %Palette{name: "Twilight",
      map_type: @maptype,
      colors: m_twilight_data,
      number: twilight_length,},
    :twilight_shifted => %Palette{name: "Twilight Shifted",
      map_type: @maptype,
      colors: m_twilight_shifted,
      number: twilight_length},
  }
