defmodule ColorMaps.Matplotlib do
  @moduledoc """
  ...
  @palettes %{
    :magma => %Palette{name: "Magma",
      map_type: @maptype,
      colors: m_MAGMA_DATA,
      number: length(m_MAGMA_DATA)},
    :inferno => %Palette{name: "Inferno",
      map_type: @maptype,
      colors: m_INFERNO_DATA,
      number: length(m_INFERNO_DATA)},
    :plasma => %Palette{name: "Plasma",
      map_type: @maptype,
      colors: m_PLASMA_DATA,
      number: length(m_PLASMA_DATA)},
    :viridis => %Palette{name: "Viridis",
      map_type: @maptype,
      colors: m_VIRIDIS_DATA,
      number: length(m_VIRIDIS_DATA)},
    :cividis => %Palette{name: "cividis",
      map_type: @maptype,
      colors: m_CIVIDIS_DATA,
      number: length(m_CIVIDIS_DATA),
      url: "https://github.com/pnnl/cmaputil"},
    :turbo => %Palette{name: "Turbo",
      map_type: @maptype,
      colors: m_turbo_data,
      number: length(m_turbo_data)},
  }
