defmodule ColorMaps.Mycarta do
  @moduledoc """
  ...
  @palettes  %{
    :cube1 => %Palette{name: "Cube1",
      map_type: @maptype,
      colors: m_CUBE1,
      number: length(m_CUBE1),},
    :cubeyf => %Palette{name: "CubeYF",
      map_type: @maptype,
      colors: m_CUBEYF,
      number: length(m_CUBEYF),},
    :linearl => %Palette{name: "LinearL",
      map_type: @maptype,
      colors: m_LINEARL,
      number: length(m_LINEARL),},
  }
  @spec name :: atom()
  def name() do
    __MODULE__
